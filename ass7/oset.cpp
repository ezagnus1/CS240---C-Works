...
void readIPaddresses(unordered_set<string>& address);
//input: unordered_set<string>
//output: none
//side effects: read Ip addresses and calculate the number of known spammer IP addresses.
void readSpammers(unordered_set<string>& address);
//input: unordered_set<string>
//output: none
...
void RemoveSpammers(unordered_set<string>& address);
//input: unordered_set<string>
//output: none
